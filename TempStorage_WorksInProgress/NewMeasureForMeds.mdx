...
CREATE MEMBER CURRENTCUBE.[Measures].[Medication Order Quantity - Opiod - Total] AS 
([Medication].[Medication - Opioid Indicator].&[YES], [Measures].[Medication Order Quantity - Total])
,VISIBLE=1, FORMAT_STRING='#,##0', ASSOCIATED_MEASURE_GROUP='Lab Order';


CREATE MEMBER CURRENTCUBE.[Measures].[Medication Order Quantity - Opiod - Total - Per Completed Encounter] AS 
iif([Measures].[Medication Order - Completed Encounter - Unique Count - Not Sliceable] = 0,
	null,
	[Measures].[Medication Order Quantity - Opiod - Total] / [Measures].[Medication Order - Completed Encounter - Unique Count - Not Sliceable]
)
,VISIBLE=1, FORMAT_STRING='#,##0.00', ASSOCIATED_MEASURE_GROUP='Medication Order';
