...
CREATE MEMBER CURRENTCUBE.[Measures].[Medication Order Quantity - Opiod - Sum - Per Completed Encounter] AS 
iif([Measures].[Medication Order - Completed Encounter - Unique Count - Not Sliceable] = 0,
	null,
	[Measures].[Medication Order Quantity - Opiod - Sum] / [Measures].[Medication Order - Completed Encounter - Unique Count - Not Sliceable]
)
,VISIBLE=0, FORMAT_STRING='#,##0.00', ASSOCIATED_MEASURE_GROUP='Medication Order';
